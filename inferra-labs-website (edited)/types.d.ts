...
export type Page = 'home' | 'about' | 'contact' | 'join-us' | 'admin-login' | 'admin-dashboard' | 'departments' | 'projects' | 'events' | 'gallery' | 'committee' | 'member-directory' | 'achievements' | 'partnerships' | 'alumni' | 'resources' | 'knowledge-hub' | 'recruitment-history';
